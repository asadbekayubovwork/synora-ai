...
<template>
  ...
  >
    ...
    <span class="absolute left-4 flex items-center">
      <svg v-if="provider === 'google'" viewBox="0 0 18 18" class="size-[19px]" aria-hidden="true">
      ...
      <svg v-else viewBox="0 0 16 16" class="size-[19px]" fill="currentColor" aria-hidden="true">
